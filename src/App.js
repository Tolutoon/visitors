    ...
    <>
      <Routes>
        ...
        {authenticated ? (
          <>
            {isAdmin ? (
              <Route path='/log' element={<Visitors handleLogout={handleLogout}/>}/>
            ) : (
              <Route path='/home' element={<Navigate to="/home" />} />
            )}
            {/* Pass the username from userProfile as a prop to RequestsWithUserId */}
            <Route path='/requests/:userId' element={<RequestsWithUserId userProfile={userProfile ? userProfile.username : null} handleLogout={handleLogout} />} />
